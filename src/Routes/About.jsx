...
function About() {
  ...
  return (
    ...
    <div style={boxStyle}>
    <div className='absolute top-72 w-full'><AboutImgText image={ProfilePicture}  title='..Me' type="rtext">I have hairdressing for about 25 years, since I was a teenager.
    ...
    </div><div className='absolute bottom-[450px] w-full'><AboutImgText image={HairProduct}  title='..Hair Products' type="ltext">I need to make sure my customers' hair will stay in perfect condition for a long time.
